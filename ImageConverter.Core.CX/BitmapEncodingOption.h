...
namespace ImageConverter {
	namespace Core {
		namespace CX {
			...
			ref class BitmapEncodingOptionInternal
			{
				static IVectorView<Format>^ GetFormats() { return nullptr; }
			};
			...
			public:
				...
				static property String^ Description
				{
					String^ get() { return L"Specifies whether to allow encoding data in the 32bpp BGRA pixel format, allowing an alpha channel to be encoded correctly. If this option is set to true, the BMP will be written with a BITMAPV5HEADER header." +
